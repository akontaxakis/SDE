...
public class RUNParallelWC {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Datapoint> DataStream2 = dataStream.flatMap(new ParalliseCoFlatMap()).keyBy((KeySelector<Datapoint, String>) Datapoint::getKey);
        DataStream<Datapoint> DataStream3 = DataStream2.flatMap(new NaiveCoFlatMap());


        env.execute("Parallel_"+parallelism+"_"+multi+"_"+kafkaDataInputTopic);
